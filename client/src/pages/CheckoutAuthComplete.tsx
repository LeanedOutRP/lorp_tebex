...
export default function CheckoutAuthComplete() {
    ...
    return (
        <Box style={{position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "linear-gradient(135deg, #000000 0%, #111111 50%, #000000 100%)", zIndex: 9999, overflow: "hidden"}}>
            <Box style={{position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "600px", height: "600px", background: "radial-gradient(circle, rgba(118, 41, 243, 0.1) 0%, transparent 70%)", animation: "pulse 3s ease-in-out infinite"}}/>
            <Center style={{height: "100vh", position: "relative", zIndex: 1}}>
                <Stack align="center" gap="xl" style={{maxWidth: 500, padding: 32}}>
                    {status === "processing" && (
                        <>
                            <Box style={{position: "relative"}}>
                                <Loader size={100} color="violet" type="dots"/>
                            </Box>
                            <Text size="2.5rem" fw={900} c="#FFFFFF" ta="center" style={{textShadow: "0 0 30px rgba(135, 41, 243, 0.3)", letterSpacing: "-0.5px"}}>
                                Processing Checkout
                            </Text>
                            ...
                            <Stack align="center" gap="xs" mt="md">
                                ...
                                <Box style={{display: "flex", gap: 8, marginTop: 16}}>
                                    <Box style={{width: 8, height: 8, background: "#9b3dff", borderRadius: "50%", animation: "bounce 1.4s ease-in-out infinite", animationDelay: "0s"}}/>
                                    <Box style={{width: 8, height: 8, background: "#9b3dff", borderRadius: "50%", animation: "bounce 1.4s ease-in-out infinite", animationDelay: "0.2s"}}/>
                                    <Box style={{width: 8, height: 8, background: "#9b3dff", borderRadius: "50%", animation: "bounce 1.4s ease-in-out infinite", animationDelay: "0.4s"}}/>
                                </Box>
                            </Stack>
                        </>
                    )}
                    {status === "success" && (
                        <>
                            <Box style={{animation: "scaleIn 0.5s ease-out"}}>
                                <CheckCircle size={100} color="#9b3dff" strokeWidth={2}/>
                            </Box>
                            <Text size="2.5rem" fw={900} c="#FFFFFF" ta="center" style={{textShadow: "0 0 30px rgba(135, 41, 243, 0.3)", letterSpacing: "-0.5px"}}>
                                Success!
                            </Text>
