        ...
        <Box>
            <Container size="lg" py={80}>
                <Stack align="center" gap="xl">
                    <Title order={1} size={60} fw={900} ta="center" style={{background: "linear-gradient(45deg, #9b3dff 0%, #260b57ff 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text"}}>
                        Welcome
                    </Title>
                    <Text size="xl" c="#FFFFFF" ta="center" maw={600}>
                        Discover exclusive incentives and enhance your roleplay experience with our
                        packages
                    </Text>
                    <Group mt="xl">
                        <Button component={Link} to="/products" size="xl" leftSection={<IconShoppingBag size={24}/>} styles={{root: {background: "#9b3dff", color: "#111111", fontWeight: 700, "&:hover": {background: "#9825dbff"}}}}>
                            Browse Packages
                        </Button>
                        <Button component={Link} to="/products" size="xl" variant="outline" leftSection={<IconBolt size={24}/>} styles={{root: {borderColor: "#9b3dff", color: "#9b3dff", "&:hover": {background: "rgba(135, 41, 243, 0.1)"}}}}>
                            Featured Deals
                        </Button>
                    </Group>
                    <Group mt={80} grow>
                        <Stack align="center" gap="sm">
                            <IconShoppingBag size={48} color="#9b3dff"/>
                            <Title order={3} c="#FFFFFF">Premium Packages</Title>
                            <Text c="#FFFFFF" ta="center">
                                High-quality packages for your character experience
                            </Text>
                        </Stack>
                        <Stack align="center" gap="sm">
                            <IconBolt size={48} color="#9b3dff"/>
                            <Title order={3} c="#FFFFFF">Instant Delivery</Title>
                            <Text c="#FFFFFF" ta="center">
                                Claim your products immediately
                            </Text>
                        </Stack>
                        <Stack align="center" gap="sm">
                            <IconShoppingBag size={48} color="#9b3dff"/>
                                                    ...
                                                    <Group gap="sm">
                                                        <Box style={{position: "relative"}}>
                                                            {payment.player?.id && payment.player?.name && !avatarErrors[payment.id] ? (
                                                                ...
                                                                <Avatar size="lg" radius="xl" style={{background: "linear-gradient(135deg, rgba(135, 41, 243, 0.2), rgba(135, 41, 243, 0.05))"}}>
                                                                    <IconUser size={24} color="#9b3dff"/>
                                                                </Avatar>
                                                            )}
                                                            <Box style={{position: "absolute", bottom: 0, right: 0, width: "12px", height: "12px", background: "#9b3dff", borderRadius: "50%", border: "2px solid #111111"}}/>
                                                        </Box>
                                                        <div>
