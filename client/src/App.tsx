        ...
        <>
            ...
            {totalItems > 0 && (
                <div style={{position: "fixed", bottom: "6rem", right: "1.5rem", zIndex: 1000}}>
                    <ActionIcon size={56} radius="xl" onClick={() => setCartOpen(true)} style={{background: "#9b3dff", color: "#111111", boxShadow: "0 4px 16px rgba(135, 41, 243, 0.5)", transition: "all 0.2s ease"}} onMouseEnter={(e) => {e.currentTarget.style.transform = "scale(1.1) translateY(-2px)", e.currentTarget.style.boxShadow = "0 6px 20px rgba(129, 41, 243, 0.6)"}} onMouseLeave={(e) => {e.currentTarget.style.transform = "scale(1) translateY(0)", e.currentTarget.style.boxShadow = "0 4px 16px rgba(145, 41, 243, 0.5)"}}>
